...
import Model.produitbeans;

/**
 *
 * @author YOUSFI
 */
public class prods extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pb.setProds(op.getallproduit());
        
        request.setAttribute("nbp", nbp);
        request.setAttribute("model", pb);
        request.getRequestDispatcher("shoping.jsp").include(request, response); 
